...
from diffusers.models.embeddings import TimestepEmbedding, Timesteps, PositionNet
from diffusers.models.modeling_utils import ModelMixin
from .transformer_temporal import TransformerTemporalModel

if os.environ.get("box2temp") == 'true':
    print(
        '**********************BOX2TEMP***********************'
    )
    from .unet_3d_blocks_gligen_boxattn import (
    ...
    from .unet_3d_blocks_gligen import (
        CrossAttnDownBlock3D,
        CrossAttnUpBlock3D,
        DownBlock3D,
        UNetMidBlock3DCrossAttn,
...
class UNet3DConditionModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        ...
        self.position_net = PositionNet(positive_len=positive_len, out_dim=cross_attention_dim, location_type='bbox')
    ...
    def forward(
        ...
        if cross_attention_kwargs is not None and cross_attention_kwargs.get("gligen", None) is not None:
            ...
            bs = sample.shape[0]
            objs, tracklet_embedding = self.position_net(**location_args)
            cross_attention_kwargs["gligen"] = {"objs": objs.flatten(0, 1).view(bs, fixed_objs, -1),
                                                "track_objs": tracklet_embedding,
